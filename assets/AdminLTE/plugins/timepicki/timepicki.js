	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prevs action-prevs'></div>" :
				"<div class='prevs action-nexts'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nexts action-nexts'></div>" :
				"<div class='nexts action-prevs'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prevs')) || direction === 'prevs') {
			...
			function change_meri(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-nexts')) || direction === 'nexts') {
					if (cur_mer == "AM") {
			...
			var cur_next = ele_next.find(".action-nexts");
			var cur_prev = ele_next.find(".action-prevs");
