<div class="content-wrapper" style="min-height: 1589.56px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>UPCOMING BLOTTER SCHEDULE</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header bg-lightblue color-palette">
          ...
          <h3 class="card-title"><i class="far fa-calendar"></i>LIST OF SCHEDULE <a href="?brgypage=monitoringschedule" class="btn btn-secondary"><i class="far fa-calendar"></i>&nbsp;ON GOING SCHEDULE <h6 class="badge badge-warning"><?php echo getNumberOfSchedule($brgy_id);?></h6></a></h3>
        </div>
          ...
          <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                <?php
                  $c = 1;
				  $now = date('m/d/Y');
				  $crud -> sql("SELECT * FROM blotter_tbl WHERE brgy_id_fk='{$brgy_id}' AND schedule_date>'{$now}' && schedule_date!='' AND status='ONGOING'");
