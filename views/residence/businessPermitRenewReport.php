        ...
        <div class="card-body table-responsive" style="display: block;">
			...
			<div class="row">
				...
				<div class="col-md-3 pull-right" >
					<a class="btn btn-default btn-flat bg-olive" href="reports/BusinessPermitRenew.print.php?resident_id=<?php echo $resident_id;?>&or=<?php echo $or?>&cedula=<?php echo $cedula;?>&brgy_id=<?php echo $brgy_id;?>" target="_blank"><i class="fa fa-print"></i></a>
				</div>
			</div><br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<p>
					being applied for <b>RENEWAL</b> of the corresponding Mayor's Permit has been found to be:
					</p>
					<br>
