<div class="content-wrapper" style="min-height: 1589.56px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Indigent Per Barangay</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Indigent</a></li>
              <li class="breadcrumb-item active">Indigent List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header bg-olive">
          ...
          <h3 class="card-title">List of Indigent Details &nbsp;
            <a href="Dashboard/Sub_Report/listofindigent.print.php?brgy_id=<?php echo $brgy_id;?>&usertypereport=<?php echo $usertype;?>" class="btn btn-dark" data-toggle="tooltip" title="Print Data" target="_blank"><span class="fa fa-print" ></span></a>
          ...
          <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
                    ...
                    <td><?php echo countDILGTblResultsIndigent("resident_tbl", "brgy_id_fk_resident", $rs_brgyvals['brgy_id'], "gender", "1", "income", "5000");?></td>
					          <td><?php echo countDILGTblResultsIndigent("resident_tbl", "brgy_id_fk_resident", $rs_brgyvals['brgy_id'], "gender", "2", "income", "5000");?></td>
		...
		<table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
                    ...
                    <td><?php echo countDILGTblResultsIndigent("resident_tbl", "sitio_id_fk_resident", $rs_sitiovalRes['sitio_id'], "gender", "1", "income", "5000");?></td>
					         <td><?php echo countDILGTblResultsIndigent("resident_tbl", "sitio_id_fk_resident", $rs_sitiovalRes['sitio_id'], "gender", "2", "income", "5000");?></td>
