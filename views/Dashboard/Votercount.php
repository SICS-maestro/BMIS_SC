<div class="content-wrapper" style="min-height: 1589.56px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>List of Voter Per Barangay</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header bg-olive">
          ...
          <h3 class="card-title">List of Voter Details &nbsp;
		  </h3>
      <a href="Dashboard/Sub_Report/listofvoter.print.php?brgy_id=<?php echo $brgy_id;?>&usertypereport=<?php echo $usertype;?>" class="btn btn-dark" data-toggle="tooltip" title="Print Data" target="_blank"><span class="fa fa-print" ></span></a>
          ...
          <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
                    ...
                    <td><?php echo countDILGTblResultsVoter("resident_tbl", "brgy_id_fk_resident", $rs_brgyvals['brgy_id'], "gender", "1", "Voter", "Yes");?></td>
					          <td><?php echo countDILGTblResultsVoter("resident_tbl", "brgy_id_fk_resident", $rs_brgyvals['brgy_id'], "gender", "2", "Voter", "Yes");?></td>
